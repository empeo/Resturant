...
if (isset($_POST['add_submit'])) {
    ...
    if (empty($error_name_item) and empty($error_price_item) and empty($error_category_item) and empty($error_image_item)) {
        $resultValuesEnsures = $dbConnection->getData("food", ["name" => $nameItem]);
        if (empty($resultValuesEnsures)) {
            ...
            $resultInsert = $dbConnection->getInsertDataCus("food", ["name" => $nameItem, "price" => $priceItem, "category" => $categoryItem, "image" => $newNameImage]);
            $resultInsert ? ($successMessage = "Successful Inserted") : ($ErrorMessage = "Failed Inserted");
        } else {
            $ErrorMessage = "Dublicated Data";
        }
    }
}
?>
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="container__name">
            ...
            <input id="itemName" type="text" name="itemName" value="<?php if (isset($nameItem)) {
                                                                        echo $nameItem;
                                                                    } ?>">
        ...
        <div class="container__price">
            ...
            <input id="priceItem" type="text" name="priceItem" value="<?php if (isset($priceItem)) {
                                                                            echo $priceItem;
                                                                        } ?>">
